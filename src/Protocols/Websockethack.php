 ...
 * WebSocket protocol.
 */
class Websockethack implements \Workerman\Protocols\ProtocolInterface
{
    /**
     * Websocket blob type.
     *
    ...
    protected static function dealHandshake($buffer, $connection)
    {
        ...
        if (0 === strpos($buffer, 'GET')) {
            ...
            if (preg_match("/Sec-WebSocket-Key: *(.*?)\r\n/i", $buffer, $match)) {
                ...
                //     true);
                // $connection->close();
                call_user_func($connection->worker->onHttpRequest, $connection, $buffer);
                return 0;
            }
